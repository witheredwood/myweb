...
Component({
  ...
  methods: {
    getElevatorHeight: function getElevatorHeight(tabs) {
      ...
      var _loop = function _loop(i) {
        my.createSelectorQuery().select("#am-tabs-elevator-pane-" + i).boundingClientRect().select('.am-tabs-bar-sticky').boundingClientRect().exec(function (ret) {
          var _this3$props = _this3.props,
              elevatorTop = _this3$props.elevatorTop,
              elevatorContentTop = _this3$props.elevatorContentTop;
          ...
          _this3.props.floorNumber[i] = ret[0].top - ret[1].height - tabContentDistance;

          _this3.setData({
            floorNumber: _this3.props.floorNumber
          });
        });
      };
      ...
      setTimeout(function () {
        _this3.$page.data.floorNumber = _this3.data.floorNumber;
      }, 100);
    },
    ...
    handleTabClick: function handleTabClick(e) {
      ...
      my.createSelectorQuery().select("#am-tabs-bar-" + tabsName + "-content").boundingClientRect().exec(function (ret) {
        ...
        if (_this4.data.elWidth > _this4.data.boxWidth / 2) {
          setTimeout(function () {
            _this4.setData({
          ...
          setTimeout(function () {
            _this4.setData({
              viewScrollLeft: e.currentTarget.offsetLeft - Math.floor(_this4.data.boxWidth / 2)
            });
          }, 300);
        }
      });
